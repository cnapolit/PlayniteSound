...
public class GameMenuFactory : BaseMenuFactory, IGameMenuFactory
{
        ...
        IItemCollectionChangedHandler itemCollectionChangedHandler) : base(fileManager, musicPlayer)
    {
        ...
        _gameMenuItems = new Lazy<List<GameMenuItem>>(() =>
        [
            ...
            ConstructGameMenuItem(Resource.ActionsCopySelectMusicFile,
                SelectedAction(_fileManager.SelectMusicForGames)),
            ConstructGameMenuItem(Resource.ActionsOpenSelected, SelectedAction(_fileManager.OpenGameDirectories)),
            ConstructGameMenuItem(Resource.ActionsDeleteSelected,
                SelectedAction(_fileManager.DeleteMusicDirectories)),
    ...
    private static GameMenuItem ConstructGameMenuItem(
        string resource, Action<GameMenuItemActionArgs> action, string subMenu = "") => new()
    {
