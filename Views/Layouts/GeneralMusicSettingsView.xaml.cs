...
{
    public partial class GeneralMusicSettingsView : UserControl
    {

        private bool _dragging = false;
        private Point _draggingStart = new Point();
        ...
        public ListBoxItem CreateDownloaderEntry(Source source, bool enabled)
        {
            ...
            toggle.Checked += (sender, args) => UpdateDownloaders();
            toggle.Unchecked += (sender, args) => UpdateDownloaders();
